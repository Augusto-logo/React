...
*When asked to document a directory (e.g., `doc: src/pages/MeuProjeto`):*
...
*When asked to create a new component (e.g., `create: component UserProfile in src/components`):*
